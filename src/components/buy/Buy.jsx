...
const Buy = () => {
  return (
    <div className="bg-[#0178BA] " id="roadmap">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 mt-3 p-20">
        <div className="relative flex justify-center">
          ...
          <h1 className="absolute top-[6rem] 2xl:left-[6rem] lg:left-[4rem] left-4 z-10 text-xl ">
            Step 1: Connect your wallet
          </h1>

          <p className="absolute top-[10rem] 2xl:left-[6rem] lg:left-[4rem] left-7 z-10 lg:w-[300px] w-[150px] md:w-[200px] text-xl">
        ...
        <div className="relative flex justify-center">
          ...
          <p className="absolute top-[10rem] 2xl:left-[6rem] lg:left-[4rem] left-7 z-10 lg:w-[300px] w-[150px] text-xl">
            Link your crypto wallet (like MetaMask or Trust Wallet) to get
            started securely
          </p>
        </div>
