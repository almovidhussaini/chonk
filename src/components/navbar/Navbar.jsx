...
import chunckicon from '../../assets/icons/chunkicon.png'
...
const Navbar = () => {
  ...
  const toggleMenu = () => {
    ...
    return (
        <nav className="bg-[#0178BA] dark:bg-gray-900 fixed w-full z-20  top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src={chunckicon} className="h-16" alt="Logo" />
        ...
        <div
          className={`${
            isOpen ? "block" : "hidden"
          } items-center justify-between w-full md:flex md:w-auto md:order-1 border-2 border-white px-2 py-1 rounded-2xl`}
          id="navbar-sticky"
        >
